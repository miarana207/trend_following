...
def build_report(assets: List[Dict[str, Any]], audit: CriterionAudit, warnings: List[str], errors: List[str], ema_diag: Optional[Dict[str, Any]] = None, ema_alerts: Optional[Dict[str, Any]] = None) -> str:
...
def main() -> int:
    ...
    if 'ema_diag' not in locals():
        ema_diag = build_ema_diagnostic(assets)
    html = build_report(assets, audit, warnings, errors, ema_diag, ema_alerts)
